const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(GALARIAN_ZIGZAGOON, gMonPalette_GalarianZigzagoon),
    ...
    SPECIES_PAL(GALARIAN_LINOONE, gMonPalette_GalarianLinoone),
    ...
    SPECIES_PAL(HISUIAN_ZORUA, gMonPalette_HisuianZorua),
    SPECIES_PAL(HISUIAN_ZOROARK, gMonPalette_HisuianZoroark),
    ...
    SPECIES_PAL(GALARIAN_MR_MIME, gMonPalette_GalarianMrMime),
    ...
    SPECIES_PAL(GALARIAN_DARUMAKA, gMonPalette_GalarianDarumaka),
    SPECIES_PAL(GALARIAN_DARMANITAN, gMonPalette_GalarianDarmanitan),
    SPECIES_PAL(ANNIHILAPE, gMonPalette_Annihilape),
    SPECIES_PAL(GALARIAN_FARFETCHD, gMonPalette_GalarianFarfetchd),
    ...
    SPECIES_PAL(HISUIAN_GROWLITHE, gMonPalette_HisuianGrowlithe),
    SPECIES_PAL(HISUIAN_ARCANINE, gMonPalette_HisuianArcanine),
    ...
    SPECIES_PAL(GALARIAN_MEOWTH, gMonPalette_GalarianMeowth),
