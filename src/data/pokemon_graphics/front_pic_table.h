const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(GALARIAN_ZIGZAGOON, gMonFrontPic_GalarianZigzagoon),
    ...
    SPECIES_SPRITE(GALARIAN_LINOONE, gMonFrontPic_GalarianLinoone),
    ...
    SPECIES_SPRITE(HISUIAN_ZORUA, gMonFrontPic_HisuianZorua),
    SPECIES_SPRITE(HISUIAN_ZOROARK, gMonFrontPic_HisuianZoroark),
    ...
    SPECIES_SPRITE(GALARIAN_MR_MIME, gMonFrontPic_GalarianMrMime),
    ...
    SPECIES_SPRITE(GALARIAN_DARUMAKA, gMonFrontPic_GalarianDarumaka),
    SPECIES_SPRITE(GALARIAN_DARMANITAN, gMonFrontPic_GalarianDarmanitan),
    SPECIES_SPRITE(ANNIHILAPE, gMonFrontPic_Annihilape),
    SPECIES_SPRITE(GALARIAN_FARFETCHD, gMonFrontPic_GalarianFarfetchd),
    ...
    SPECIES_SPRITE(HISUIAN_GROWLITHE, gMonFrontPic_HisuianGrowlithe),
    SPECIES_SPRITE(HISUIAN_ARCANINE, gMonFrontPic_HisuianArcanine),
    ...
    SPECIES_SPRITE(GALARIAN_MEOWTH, gMonFrontPic_GalarianMeowth),
