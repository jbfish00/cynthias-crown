const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(GALARIAN_ZIGZAGOON, gMonBackPic_GalarianZigzagoon),
    ...
    SPECIES_SPRITE(GALARIAN_LINOONE, gMonBackPic_GalarianLinoone),
    ...
    SPECIES_SPRITE(HISUIAN_ZORUA, gMonBackPic_HisuianZorua),
    SPECIES_SPRITE(HISUIAN_ZOROARK, gMonBackPic_HisuianZoroark),
    ...
    SPECIES_SPRITE(GALARIAN_MR_MIME, gMonBackPic_GalarianMrMime),
    ...
    SPECIES_SPRITE(GALARIAN_DARUMAKA, gMonBackPic_GalarianDarumaka),
    SPECIES_SPRITE(GALARIAN_DARMANITAN, gMonBackPic_GalarianDarmanitan),
    SPECIES_SPRITE(ANNIHILAPE, gMonBackPic_Annihilape),
    SPECIES_SPRITE(GALARIAN_FARFETCHD, gMonBackPic_GalarianFarfetchd),
    ...
    SPECIES_SPRITE(HISUIAN_GROWLITHE, gMonBackPic_HisuianGrowlithe),
    SPECIES_SPRITE(HISUIAN_ARCANINE, gMonBackPic_HisuianArcanine),
    ...
    SPECIES_SPRITE(GALARIAN_MEOWTH, gMonBackPic_GalarianMeowth),
