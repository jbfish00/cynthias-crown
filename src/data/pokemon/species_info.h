...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    // === TypeShrine single-species starters (IDs 412-415, gap between Chimecho and step5) ===
    [SPECIES_SHINX] =
    {
        .baseHP = 45,
        .baseAttack = 65,
    ...
    // === Cynthia's Crown custom species (generated stats via tools/step5_cache) ===
#include "../../../build/step5_species_info.inc"
};
