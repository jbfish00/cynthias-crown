...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_GALARIAN_ZIGZAGOON]  = gMonIcon_GalarianZigzagoon,
    ...
    [SPECIES_GALARIAN_LINOONE] = gMonIcon_GalarianLinoone,
    ...
    [SPECIES_HISUIAN_ZORUA] = gMonIcon_HisuianZorua,
    [SPECIES_HISUIAN_ZOROARK] = gMonIcon_HisuianZoroark,
    ...
    [SPECIES_GALARIAN_MR_MIME] = gMonIcon_GalarianMrMime,
    ...
    [SPECIES_GALARIAN_FARFETCHD] = gMonIcon_GalarianFarfetchd,
    ...
    [SPECIES_HISUIAN_GROWLITHE] = gMonIcon_HisuianGrowlithe,
    [SPECIES_HISUIAN_ARCANINE] = gMonIcon_HisuianArcanine,
    ...
    [SPECIES_GALARIAN_MEOWTH] = gMonIcon_GalarianMeowth,
...
const u8 gMonIconPaletteIndices[] = {
    ...
    [SPECIES_MUNCHLAX] = 0,
    [SPECIES_PORYGON_Z] = 0,
    [SPECIES_HISUIAN_ZORUA] = 2,
    [SPECIES_HISUIAN_ZOROARK] = 2,
    ...
    [SPECIES_FROSLASS] = 2,
    [SPECIES_WEAVILE] = 0,
    [SPECIES_GALARIAN_DARUMAKA] = 2,
    [SPECIES_GALARIAN_DARMANITAN] = 2,
    [SPECIES_ANNIHILAPE] = 2,
    [SPECIES_GALARIAN_FARFETCHD] = 2,
    [SPECIES_SIRFETCHD] = 2,
    [SPECIES_PANCHAM] = 0,
    [SPECIES_PANGORO] = 0,
    [SPECIES_CROAGUNK] = 0,
    ...
    [SPECIES_KLEAVOR] = 2,
    [SPECIES_HISUIAN_GROWLITHE] = 2,
    [SPECIES_HISUIAN_ARCANINE] = 2,
