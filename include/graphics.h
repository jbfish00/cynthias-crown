...
extern const u32 gMonFrontPic_GalarianZigzagoon[];
extern const u32 gMonPalette_GalarianZigzagoon[];
extern const u32 gMonBackPic_GalarianZigzagoon[];
extern const u32 gMonShinyPalette_GalarianZigzagoon[];
extern const u8 gMonIcon_GalarianZigzagoon[];
extern const u8 gMonFootprint_GalarianZigzagoon[];
...
// Cynthia's Crown Step 5 species (416-579)
...
extern const u32 gMonFrontPic_GalarianLinoone[];
extern const u32 gMonPalette_GalarianLinoone[];
extern const u32 gMonBackPic_GalarianLinoone[];
extern const u32 gMonShinyPalette_GalarianLinoone[];
extern const u8 gMonIcon_GalarianLinoone[];
extern const u8 gMonFootprint_GalarianLinoone[];
...
extern const u32 gMonFrontPic_HisuianZorua[];
extern const u32 gMonPalette_HisuianZorua[];
extern const u32 gMonBackPic_HisuianZorua[];
extern const u32 gMonShinyPalette_HisuianZorua[];
extern const u8 gMonIcon_HisuianZorua[];
extern const u8 gMonFootprint_HisuianZorua[];

extern const u32 gMonFrontPic_HisuianZoroark[];
extern const u32 gMonPalette_HisuianZoroark[];
extern const u32 gMonBackPic_HisuianZoroark[];
extern const u32 gMonShinyPalette_HisuianZoroark[];
extern const u8 gMonIcon_HisuianZoroark[];
extern const u8 gMonFootprint_HisuianZoroark[];
...
extern const u8 gMonFootprint_RotomHeat[];
...
extern const u8 gMonFootprint_RotomWash[];
...
extern const u8 gMonFootprint_RotomFrost[];
...
extern const u8 gMonFootprint_RotomFan[];
...
extern const u8 gMonFootprint_RotomMow[];
...
extern const u32 gMonFrontPic_GalarianMrMime[];
extern const u32 gMonPalette_GalarianMrMime[];
extern const u32 gMonBackPic_GalarianMrMime[];
extern const u32 gMonShinyPalette_GalarianMrMime[];
extern const u8 gMonIcon_GalarianMrMime[];
extern const u8 gMonFootprint_GalarianMrMime[];
...
extern const u32 gMonFrontPic_GalarianDarumaka[];
extern const u32 gMonPalette_GalarianDarumaka[];
extern const u32 gMonBackPic_GalarianDarumaka[];
extern const u32 gMonShinyPalette_GalarianDarumaka[];
extern const u8 gMonIcon_GalarianDarumaka[];
extern const u8 gMonFootprint_GalarianDarumaka[];

extern const u32 gMonFrontPic_GalarianDarmanitan[];
extern const u32 gMonPalette_GalarianDarmanitan[];
extern const u32 gMonBackPic_GalarianDarmanitan[];
extern const u32 gMonShinyPalette_GalarianDarmanitan[];
extern const u8 gMonIcon_GalarianDarmanitan[];
extern const u8 gMonFootprint_GalarianDarmanitan[];
...
extern const u8 gMonFootprint_GalarianFarfetchd[];
...
extern const u32 gMonFrontPic_HisuianGrowlithe[];
extern const u32 gMonPalette_HisuianGrowlithe[];
extern const u32 gMonBackPic_HisuianGrowlithe[];
extern const u32 gMonShinyPalette_HisuianGrowlithe[];
extern const u8 gMonIcon_HisuianGrowlithe[];
extern const u8 gMonFootprint_HisuianGrowlithe[];

extern const u32 gMonFrontPic_HisuianArcanine[];
extern const u32 gMonPalette_HisuianArcanine[];
extern const u32 gMonBackPic_HisuianArcanine[];
extern const u32 gMonShinyPalette_HisuianArcanine[];
extern const u8 gMonIcon_HisuianArcanine[];
extern const u8 gMonFootprint_HisuianArcanine[];
...
extern const u8 gMonFootprint_GalarianMeowth[];
...
// Fire starter lines (Gen 5-9)
extern const u32 gMonFrontPic_Tepig[]; extern const u32 gMonPalette_Tepig[]; extern const u32 gMonBackPic_Tepig[]; extern const u32 gMonShinyPalette_Tepig[]; extern const u8 gMonIcon_Tepig[]; extern const u8 gMonFootprint_Tepig[];
extern const u32 gMonFrontPic_Pignite[]; extern const u32 gMonPalette_Pignite[]; extern const u32 gMonBackPic_Pignite[]; extern const u32 gMonShinyPalette_Pignite[]; extern const u8 gMonIcon_Pignite[]; extern const u8 gMonFootprint_Pignite[];
extern const u32 gMonFrontPic_Emboar[]; extern const u32 gMonPalette_Emboar[]; extern const u32 gMonBackPic_Emboar[]; extern const u32 gMonShinyPalette_Emboar[]; extern const u8 gMonIcon_Emboar[]; extern const u8 gMonFootprint_Emboar[];
extern const u32 gMonFrontPic_Fennekin[]; extern const u32 gMonPalette_Fennekin[]; extern const u32 gMonBackPic_Fennekin[]; extern const u32 gMonShinyPalette_Fennekin[]; extern const u8 gMonIcon_Fennekin[]; extern const u8 gMonFootprint_Fennekin[];
extern const u32 gMonFrontPic_Braixen[]; extern const u32 gMonPalette_Braixen[]; extern const u32 gMonBackPic_Braixen[]; extern const u32 gMonShinyPalette_Braixen[]; extern const u8 gMonIcon_Braixen[]; extern const u8 gMonFootprint_Braixen[];
extern const u32 gMonFrontPic_Delphox[]; extern const u32 gMonPalette_Delphox[]; extern const u32 gMonBackPic_Delphox[]; extern const u32 gMonShinyPalette_Delphox[]; extern const u8 gMonIcon_Delphox[]; extern const u8 gMonFootprint_Delphox[];
extern const u32 gMonFrontPic_Litten[]; extern const u32 gMonPalette_Litten[]; extern const u32 gMonBackPic_Litten[]; extern const u32 gMonShinyPalette_Litten[]; extern const u8 gMonIcon_Litten[]; extern const u8 gMonFootprint_Litten[];
extern const u32 gMonFrontPic_Torracat[]; extern const u32 gMonPalette_Torracat[]; extern const u32 gMonBackPic_Torracat[]; extern const u32 gMonShinyPalette_Torracat[]; extern const u8 gMonIcon_Torracat[]; extern const u8 gMonFootprint_Torracat[];
extern const u32 gMonFrontPic_Incineroar[]; extern const u32 gMonPalette_Incineroar[]; extern const u32 gMonBackPic_Incineroar[]; extern const u32 gMonShinyPalette_Incineroar[]; extern const u8 gMonIcon_Incineroar[]; extern const u8 gMonFootprint_Incineroar[];
extern const u32 gMonFrontPic_Scorbunny[]; extern const u32 gMonPalette_Scorbunny[]; extern const u32 gMonBackPic_Scorbunny[]; extern const u32 gMonShinyPalette_Scorbunny[]; extern const u8 gMonIcon_Scorbunny[]; extern const u8 gMonFootprint_Scorbunny[];
extern const u32 gMonFrontPic_Raboot[]; extern const u32 gMonPalette_Raboot[]; extern const u32 gMonBackPic_Raboot[]; extern const u32 gMonShinyPalette_Raboot[]; extern const u8 gMonIcon_Raboot[]; extern const u8 gMonFootprint_Raboot[];
extern const u32 gMonFrontPic_Cinderace[]; extern const u32 gMonPalette_Cinderace[]; extern const u32 gMonBackPic_Cinderace[]; extern const u32 gMonShinyPalette_Cinderace[]; extern const u8 gMonIcon_Cinderace[]; extern const u8 gMonFootprint_Cinderace[];
extern const u32 gMonFrontPic_Fuecoco[]; extern const u32 gMonPalette_Fuecoco[]; extern const u32 gMonBackPic_Fuecoco[]; extern const u32 gMonShinyPalette_Fuecoco[]; extern const u8 gMonIcon_Fuecoco[]; extern const u8 gMonFootprint_Fuecoco[];
extern const u32 gMonFrontPic_Crocalor[]; extern const u32 gMonPalette_Crocalor[]; extern const u32 gMonBackPic_Crocalor[]; extern const u32 gMonShinyPalette_Crocalor[]; extern const u8 gMonIcon_Crocalor[]; extern const u8 gMonFootprint_Crocalor[];
extern const u32 gMonFrontPic_Skeledirge[]; extern const u32 gMonPalette_Skeledirge[]; extern const u32 gMonBackPic_Skeledirge[]; extern const u32 gMonShinyPalette_Skeledirge[]; extern const u8 gMonIcon_Skeledirge[]; extern const u8 gMonFootprint_Skeledirge[];
// Water starter lines (Gen 5-9)
extern const u32 gMonFrontPic_Oshawott[]; extern const u32 gMonPalette_Oshawott[]; extern const u32 gMonBackPic_Oshawott[]; extern const u32 gMonShinyPalette_Oshawott[]; extern const u8 gMonIcon_Oshawott[]; extern const u8 gMonFootprint_Oshawott[];
extern const u32 gMonFrontPic_Dewott[]; extern const u32 gMonPalette_Dewott[]; extern const u32 gMonBackPic_Dewott[]; extern const u32 gMonShinyPalette_Dewott[]; extern const u8 gMonIcon_Dewott[]; extern const u8 gMonFootprint_Dewott[];
extern const u32 gMonFrontPic_Samurott[]; extern const u32 gMonPalette_Samurott[]; extern const u32 gMonBackPic_Samurott[]; extern const u32 gMonShinyPalette_Samurott[]; extern const u8 gMonIcon_Samurott[]; extern const u8 gMonFootprint_Samurott[];
extern const u32 gMonFrontPic_Froakie[]; extern const u32 gMonPalette_Froakie[]; extern const u32 gMonBackPic_Froakie[]; extern const u32 gMonShinyPalette_Froakie[]; extern const u8 gMonIcon_Froakie[]; extern const u8 gMonFootprint_Froakie[];
extern const u32 gMonFrontPic_Frogadier[]; extern const u32 gMonPalette_Frogadier[]; extern const u32 gMonBackPic_Frogadier[]; extern const u32 gMonShinyPalette_Frogadier[]; extern const u8 gMonIcon_Frogadier[]; extern const u8 gMonFootprint_Frogadier[];
extern const u32 gMonFrontPic_Greninja[]; extern const u32 gMonPalette_Greninja[]; extern const u32 gMonBackPic_Greninja[]; extern const u32 gMonShinyPalette_Greninja[]; extern const u8 gMonIcon_Greninja[]; extern const u8 gMonFootprint_Greninja[];
extern const u32 gMonFrontPic_Popplio[]; extern const u32 gMonPalette_Popplio[]; extern const u32 gMonBackPic_Popplio[]; extern const u32 gMonShinyPalette_Popplio[]; extern const u8 gMonIcon_Popplio[]; extern const u8 gMonFootprint_Popplio[];
extern const u32 gMonFrontPic_Brionne[]; extern const u32 gMonPalette_Brionne[]; extern const u32 gMonBackPic_Brionne[]; extern const u32 gMonShinyPalette_Brionne[]; extern const u8 gMonIcon_Brionne[]; extern const u8 gMonFootprint_Brionne[];
extern const u32 gMonFrontPic_Primarina[]; extern const u32 gMonPalette_Primarina[]; extern const u32 gMonBackPic_Primarina[]; extern const u32 gMonShinyPalette_Primarina[]; extern const u8 gMonIcon_Primarina[]; extern const u8 gMonFootprint_Primarina[];
extern const u32 gMonFrontPic_Sobble[]; extern const u32 gMonPalette_Sobble[]; extern const u32 gMonBackPic_Sobble[]; extern const u32 gMonShinyPalette_Sobble[]; extern const u8 gMonIcon_Sobble[]; extern const u8 gMonFootprint_Sobble[];
extern const u32 gMonFrontPic_Drizzile[]; extern const u32 gMonPalette_Drizzile[]; extern const u32 gMonBackPic_Drizzile[]; extern const u32 gMonShinyPalette_Drizzile[]; extern const u8 gMonIcon_Drizzile[]; extern const u8 gMonFootprint_Drizzile[];
extern const u32 gMonFrontPic_Inteleon[]; extern const u32 gMonPalette_Inteleon[]; extern const u32 gMonBackPic_Inteleon[]; extern const u32 gMonShinyPalette_Inteleon[]; extern const u8 gMonIcon_Inteleon[]; extern const u8 gMonFootprint_Inteleon[];
extern const u32 gMonFrontPic_Quaxly[]; extern const u32 gMonPalette_Quaxly[]; extern const u32 gMonBackPic_Quaxly[]; extern const u32 gMonShinyPalette_Quaxly[]; extern const u8 gMonIcon_Quaxly[]; extern const u8 gMonFootprint_Quaxly[];
extern const u32 gMonFrontPic_Quaxwell[]; extern const u32 gMonPalette_Quaxwell[]; extern const u32 gMonBackPic_Quaxwell[]; extern const u32 gMonShinyPalette_Quaxwell[]; extern const u8 gMonIcon_Quaxwell[]; extern const u8 gMonFootprint_Quaxwell[];
extern const u32 gMonFrontPic_Quaquaval[]; extern const u32 gMonPalette_Quaquaval[]; extern const u32 gMonBackPic_Quaquaval[]; extern const u32 gMonShinyPalette_Quaquaval[]; extern const u8 gMonIcon_Quaquaval[]; extern const u8 gMonFootprint_Quaquaval[];
// Grass starter lines (Gen 4-9)
extern const u32 gMonFrontPic_Turtwig[]; extern const u32 gMonPalette_Turtwig[]; extern const u32 gMonBackPic_Turtwig[]; extern const u32 gMonShinyPalette_Turtwig[]; extern const u8 gMonIcon_Turtwig[]; extern const u8 gMonFootprint_Turtwig[];
extern const u32 gMonFrontPic_Grotle[]; extern const u32 gMonPalette_Grotle[]; extern const u32 gMonBackPic_Grotle[]; extern const u32 gMonShinyPalette_Grotle[]; extern const u8 gMonIcon_Grotle[]; extern const u8 gMonFootprint_Grotle[];
extern const u32 gMonFrontPic_Torterra[]; extern const u32 gMonPalette_Torterra[]; extern const u32 gMonBackPic_Torterra[]; extern const u32 gMonShinyPalette_Torterra[]; extern const u8 gMonIcon_Torterra[]; extern const u8 gMonFootprint_Torterra[];
extern const u32 gMonFrontPic_Snivy[]; extern const u32 gMonPalette_Snivy[]; extern const u32 gMonBackPic_Snivy[]; extern const u32 gMonShinyPalette_Snivy[]; extern const u8 gMonIcon_Snivy[]; extern const u8 gMonFootprint_Snivy[];
extern const u32 gMonFrontPic_Servine[]; extern const u32 gMonPalette_Servine[]; extern const u32 gMonBackPic_Servine[]; extern const u32 gMonShinyPalette_Servine[]; extern const u8 gMonIcon_Servine[]; extern const u8 gMonFootprint_Servine[];
extern const u32 gMonFrontPic_Serperior[]; extern const u32 gMonPalette_Serperior[]; extern const u32 gMonBackPic_Serperior[]; extern const u32 gMonShinyPalette_Serperior[]; extern const u8 gMonIcon_Serperior[]; extern const u8 gMonFootprint_Serperior[];
extern const u32 gMonFrontPic_Chespin[]; extern const u32 gMonPalette_Chespin[]; extern const u32 gMonBackPic_Chespin[]; extern const u32 gMonShinyPalette_Chespin[]; extern const u8 gMonIcon_Chespin[]; extern const u8 gMonFootprint_Chespin[];
extern const u32 gMonFrontPic_Quilladin[]; extern const u32 gMonPalette_Quilladin[]; extern const u32 gMonBackPic_Quilladin[]; extern const u32 gMonShinyPalette_Quilladin[]; extern const u8 gMonIcon_Quilladin[]; extern const u8 gMonFootprint_Quilladin[];
extern const u32 gMonFrontPic_Chesnaught[]; extern const u32 gMonPalette_Chesnaught[]; extern const u32 gMonBackPic_Chesnaught[]; extern const u32 gMonShinyPalette_Chesnaught[]; extern const u8 gMonIcon_Chesnaught[]; extern const u8 gMonFootprint_Chesnaught[];
extern const u32 gMonFrontPic_Rowlet[]; extern const u32 gMonPalette_Rowlet[]; extern const u32 gMonBackPic_Rowlet[]; extern const u32 gMonShinyPalette_Rowlet[]; extern const u8 gMonIcon_Rowlet[]; extern const u8 gMonFootprint_Rowlet[];
extern const u32 gMonFrontPic_Dartrix[]; extern const u32 gMonPalette_Dartrix[]; extern const u32 gMonBackPic_Dartrix[]; extern const u32 gMonShinyPalette_Dartrix[]; extern const u8 gMonIcon_Dartrix[]; extern const u8 gMonFootprint_Dartrix[];
extern const u32 gMonFrontPic_Decidueye[]; extern const u32 gMonPalette_Decidueye[]; extern const u32 gMonBackPic_Decidueye[]; extern const u32 gMonShinyPalette_Decidueye[]; extern const u8 gMonIcon_Decidueye[]; extern const u8 gMonFootprint_Decidueye[];
extern const u32 gMonFrontPic_Grookey[]; extern const u32 gMonPalette_Grookey[]; extern const u32 gMonBackPic_Grookey[]; extern const u32 gMonShinyPalette_Grookey[]; extern const u8 gMonIcon_Grookey[]; extern const u8 gMonFootprint_Grookey[];
extern const u32 gMonFrontPic_Thwackey[]; extern const u32 gMonPalette_Thwackey[]; extern const u32 gMonBackPic_Thwackey[]; extern const u32 gMonShinyPalette_Thwackey[]; extern const u8 gMonIcon_Thwackey[]; extern const u8 gMonFootprint_Thwackey[];
extern const u32 gMonFrontPic_Rillaboom[]; extern const u32 gMonPalette_Rillaboom[]; extern const u32 gMonBackPic_Rillaboom[]; extern const u32 gMonShinyPalette_Rillaboom[]; extern const u8 gMonIcon_Rillaboom[]; extern const u8 gMonFootprint_Rillaboom[];
extern const u32 gMonFrontPic_Sprigatito[]; extern const u32 gMonPalette_Sprigatito[]; extern const u32 gMonBackPic_Sprigatito[]; extern const u32 gMonShinyPalette_Sprigatito[]; extern const u8 gMonIcon_Sprigatito[]; extern const u8 gMonFootprint_Sprigatito[];
extern const u32 gMonFrontPic_Floragato[]; extern const u32 gMonPalette_Floragato[]; extern const u32 gMonBackPic_Floragato[]; extern const u32 gMonShinyPalette_Floragato[]; extern const u8 gMonIcon_Floragato[]; extern const u8 gMonFootprint_Floragato[];
extern const u32 gMonFrontPic_Meowscarada[]; extern const u32 gMonPalette_Meowscarada[]; extern const u32 gMonBackPic_Meowscarada[]; extern const u32 gMonShinyPalette_Meowscarada[]; extern const u8 gMonIcon_Meowscarada[]; extern const u8 gMonFootprint_Meowscarada[];
// Rock fossil lines (Gen 4, 6)
extern const u32 gMonFrontPic_Cranidos[]; extern const u32 gMonPalette_Cranidos[]; extern const u32 gMonBackPic_Cranidos[]; extern const u32 gMonShinyPalette_Cranidos[]; extern const u8 gMonIcon_Cranidos[]; extern const u8 gMonFootprint_Cranidos[];
extern const u32 gMonFrontPic_Rampardos[]; extern const u32 gMonPalette_Rampardos[]; extern const u32 gMonBackPic_Rampardos[]; extern const u32 gMonShinyPalette_Rampardos[]; extern const u8 gMonIcon_Rampardos[]; extern const u8 gMonFootprint_Rampardos[];
extern const u32 gMonFrontPic_Shieldon[]; extern const u32 gMonPalette_Shieldon[]; extern const u32 gMonBackPic_Shieldon[]; extern const u32 gMonShinyPalette_Shieldon[]; extern const u8 gMonIcon_Shieldon[]; extern const u8 gMonFootprint_Shieldon[];
extern const u32 gMonFrontPic_Bastiodon[]; extern const u32 gMonPalette_Bastiodon[]; extern const u32 gMonBackPic_Bastiodon[]; extern const u32 gMonShinyPalette_Bastiodon[]; extern const u8 gMonIcon_Bastiodon[]; extern const u8 gMonFootprint_Bastiodon[];
extern const u32 gMonFrontPic_Tyrunt[]; extern const u32 gMonPalette_Tyrunt[]; extern const u32 gMonBackPic_Tyrunt[]; extern const u32 gMonShinyPalette_Tyrunt[]; extern const u8 gMonIcon_Tyrunt[]; extern const u8 gMonFootprint_Tyrunt[];
extern const u32 gMonFrontPic_Tyrantrum[]; extern const u32 gMonPalette_Tyrantrum[]; extern const u32 gMonBackPic_Tyrantrum[]; extern const u32 gMonShinyPalette_Tyrantrum[]; extern const u8 gMonIcon_Tyrantrum[]; extern const u8 gMonFootprint_Tyrantrum[];
extern const u32 gMonFrontPic_Amaura[]; extern const u32 gMonPalette_Amaura[]; extern const u32 gMonBackPic_Amaura[]; extern const u32 gMonShinyPalette_Amaura[]; extern const u8 gMonIcon_Amaura[]; extern const u8 gMonFootprint_Amaura[];
extern const u32 gMonFrontPic_Aurorus[]; extern const u32 gMonPalette_Aurorus[]; extern const u32 gMonBackPic_Aurorus[]; extern const u32 gMonShinyPalette_Aurorus[]; extern const u8 gMonIcon_Aurorus[]; extern const u8 gMonFootprint_Aurorus[];
